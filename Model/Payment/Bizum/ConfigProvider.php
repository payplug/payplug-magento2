...
namespace Payplug\Payments\Model\Payment\Bizum;
...
class ConfigProvider extends PayplugConfigProvider implements ConfigProviderInterface
{
     ...
     * @var string
     */
    private string $methodCode = Bizum::METHOD_CODE;
    ...
    public function getConfig(): array
    {
        return $this->method->isAvailable() ? [
            'payment' => [
                $this->methodCode => [
                    'logo' => $this->getViewFileUrl('Payplug_Payments::images/logos/bizum.svg'),
                ],
            ],
        ] : [];
    }

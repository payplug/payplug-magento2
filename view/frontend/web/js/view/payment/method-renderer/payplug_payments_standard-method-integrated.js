...
define([
    ...
    return Component.extend({
        ...
        initPaymentForm: function () {
            ...
            this.integratedForm = this.buildIntegratedForm();
        ...
        /**
         * Build Integrated Form
         * @returns {Object}
         */
        buildIntegratedForm: function () {
            return {
                cardholder: {
                    element: this.integratedApi.cardHolder(
                        document.querySelector('.cardholder-input-container'),
                        {
                            default: this.inputStyle.default,
                            placeholder: $t('Payplug Card Holder placeholder')
                        }
                    ),
                    valid: false
                },
                pan: {
                    element: this.integratedApi.cardNumber(
                        document.querySelector('.pan-input-container'),
                        {
                            default: this.inputStyle.default,
                            placeholder: $t('Payplug Card Number placeholder')
                        }
                    ),
                    valid: false
                },
                cvv: {
                    element: this.integratedApi.cvv(
                        document.querySelector('.cvv-input-container'),
                        {
                            default: this.inputStyle.default,
                            placeholder: $t('Payplug Card CVV placeholder')
                        }
                    ),
                    valid: false
                },
                exp: {
                    element: this.integratedApi.expiration(
                        document.querySelector('.exp-input-container'),
                        {
                            default: this.inputStyle.default,
                            placeholder: $t('Payplug Card Expiration placeholder')
                        }
                    ),
                    valid: false
                }

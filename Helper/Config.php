...
class Config extends AbstractHelper
{
    ...
    public function clearConfig()
    {
        $keys = [
            ...
            'payment/payplug_payments_oney/min_threshold',
            'payment/payplug_payments_oney/max_threshold',
            ...
            'payment/payplug_payments_oney_without_fees/min_threshold',
            'payment/payplug_payments_oney_without_fees/max_threshold',

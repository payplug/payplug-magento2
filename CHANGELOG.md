...
## [4.5.1](https://github.com/payplug/payplug-magento2/releases/tag/v4.5.1) - 2025-08-20
...
- Orders now default to **Pending Payment** (not Payment Review) after creation in all payment flows.

...
## [4.5.1](https://github.com/payplug/payplug-magento2/releases/tag/v4.5.1) - 2025-XX-XX

### Features

- Fix Apple pay button disabled after payment cancel

**[View diff](https://github.com/payplug/payplug-magento2/compare/v4.5.0...v4.5.1)**
